...
* `/data/docker/containers/samba/config/supervisor:/etc/supervisor.d` - Optional if you want to have a fixed set of supervisor files, please note if you use this you MUST define syslog,chrony and samba manually.  if you do not provide this samba.ini will be created at start time to kickoff these programs.  You almost definitly do NOT want to define this!
